...
export const Login = () => {
  ...
  return (
    <div className="bg-orange-100 h-screen">
      <h1 className="text-5xl md:text-6xl font-bold text-center w-full py-30">ログイン</h1>
      <form>
        <div className="flex flex-col items-center space-y-4">
          ...
          <InputField
            ...
            className="mb-12 w-100 md:w-200 h-15 px-4 py-2 border rounded-lg bg-gray-100 placeholder-gray-500 placeholder-text-xl"
          />
        </div>
        <p className="flex items-center justify-center my-8 text-xl md:text-2xl">
          パスワードをお忘れですか？
