    ...
    >
      ...
      <div className="w-full max-w-[600px] flex flex-col items-center gap-6 md:gap-10">
        ...
        <form className="w-full flex flex-col items-center gap-6 md:gap-10">
          ...
          <div className="w-full flex flex-row justify-center gap-20 md:gap-50">
            <CustomButton
              type="button"
              label="もどる"
              onClick={() => navigate(-1)}
              className="
                w-28 md:w-40
                h-10 md:h-14
                bg-gray-300 text-black text-sm md:text-xl font-bold
            ...
            <CustomButton
              ...
              className="
                w-28 md:w-40
                h-10 md:h-14
                bg-blue-500 text-black text-sm md:text-xl font-bold
