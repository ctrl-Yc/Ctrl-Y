      ...
      <div className="mx-20 space-y-4">
        <div>
          ...
          <ToggleSwitch
            ...
            className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full 
                      ...
                      after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-orange-300 dark:peer-checked:bg-orange-300"
          />
        </div>
